...
class HtmlRenderer
{
    ...
    public function genHtml()
    {
        ...
        $str = implode(', ', $htmlstr);
        $html = <<<HTM
<div style="position: fixed; right: 0; bottom: 0; background-color: #333; color: #DDD; border-top: 1px solid #DDD; border-left: 1px solid #DDD; padding: 2px; font-size: 12px;">
 $str
</div>
HTM;
        return $html;
